...
// ------------------------------------------------------------ Oracle Connection Setup Start-------------------------------------------------------------
                                        ...
                                        $query2 = "SELECT * FROM USER_REGISTRATION ORDER BY ID ASC";
...
// ------------------------------------------------------------ Oracle Connection Setup End---------------------------------------------------------------
                                            ...
                                            ?>
                                                <tr>
                                                    ...
                                                    <td><a href="delete_user.php?USERNAME=<?php echo $row["USERNAME"]; ?>" style="cursor: pointer; color:red;">Delete</a></td>
                                                </tr>
                                            <?php
                                        }
                                    ?>
